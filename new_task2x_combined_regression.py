...
def train_single_head_model(model, train_loader, val_loader, epochs=10, resume=True):
    model_save_dir = 'new_models/task2x_regression/'
    ...
    if resume:
        ...
        if resumed and best_val_loss < float('inf'):
            ...
            best_model_path = os.path.join(model_save_dir, 'best_single_head_regression_model.pt')
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(best_model_state, os.path.join(model_save_dir, 'best_single_head_regression_model.pt'))
