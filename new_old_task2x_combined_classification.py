# New ordinal architecture for Task 2x with old data
import torch
...
# Load data
texts_path = './old_data/data/Task2/texts'
...
# Task 2.1
train21 = pd.read_csv('./old_data/data/Task2/task2.1/train.csv')
valid21 = pd.read_csv('./old_data/data/Task2/task2.1/valid.csv')
...
# Task 2.2
train22 = pd.read_csv('./old_data/data/Task2/task2.2/train.csv')
valid22 = pd.read_csv('./old_data/data/Task2/task2.2/valid.csv')
...
def train_single_head_model(model, train_loader, val_loader, epochs=10, resume=True):
    model_save_dir = 'new_models/task2x_ordinal_classification_old_data/'
